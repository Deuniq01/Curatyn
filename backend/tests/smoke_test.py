...
AI_BACKEND=mock). Exercises the golden path plus the two properties the
PRD cares about most: failed sends leave reviewed fields untouched, and a
duplicate send with the same idempotency key does not double-send.
"""
import io
import uuid
